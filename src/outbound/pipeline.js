...
async function scoreCandidate(brief, company, person, size) {
  const system = 'You score outbound leads for Nivaria, a competitor-intelligence app for SaaS '
    ...
    + 'bootstrapped and indie companies, agencies, and startups from pre-seed through Series B, up '
    + 'to roughly 200 to 250 people. Only the clearly enterprise tier scores low on fit: Series C '
    + 'and beyond, unicorns, public companies, and companies with thousands of employees, because '
    + 'they buy an enterprise competitive-intelligence suite instead. A size_band of "unknown" '
    + 'means the size could not be researched, NOT that the company is big: most small companies '
    + 'have thin public data, so treat an unknown size as a neutral fit signal and never dock fit '
    + 'for it. A size_band of "borderline" is in scope and must not be scored near zero on fit '
    + 'alone. If the candidate itself BUILDS, '
